...
/* 
 * minli-port-181011
 * eMMC is connect to SD3 port,and initialized to dev 1
 * in board_mmc_init routine which is located in file mx6qp_S11.c
...
/* 
 * minli-port-181011
 * the boot partition or user partition index
 * in eMMC 
...
*/
#define CONFIG_ANDROID_BOOT_PARTITION_MMC 0
#define CONFIG_ANDROID_SDCARD_PARTITION_MMC 1
#define CONFIG_ANDROID_SYSTEM_PARTITION_MMC 2
#define CONFIG_ANDROID_RECOVERY_PARTITION_MMC 3
#define CONFIG_ANDROID_DATA_PARTITION_MMC 5
#define CONFIG_ANDROID_CACHE_PARTITION_MMC 6
#define CONFIG_ANDROID_PRIVATE_PARTITION_MMC 7
#define CONFIG_ANDROID_RESC_PARTITION_MMC 8
#define CONFIG_ANDROID_BOOT_B_PARTITION_MMC 9
#define CONFIG_ANDROID_RECOVERY_B_PARTITION_MMC 10
#define CONFIG_ANDROID_SYSTEM_B_PARTITION_MMC 11
#define CONFIG_ANDROID_MAP_PARTITION_MMC 12
 ...
 */
#define CONFIG_USB_FASTBOOT_BUF_SIZE   0x4E000000
#endif
