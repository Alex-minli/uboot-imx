...
#define CONFIG_BOOTARGS \
	"console=" CONFIG_CONSOLE_DEV ",115200 " \
	"init=/init " \
	"video=mxcfb0:dev=ldb,bpp=32 " \
	"video=mxcfb1:dev=lcd,bpp=32 " \
	"video=mxcfb2:off " \
	"video=mxcfb3:off " \
	"vmalloc=256M " \
...
#define CONFIG_BOOT_TYPE_SET \
	"mmc dev 1;" \
	"mmc write ${params_loadaddr} 7800 1" \

#define CONFIG_BOOT_JUDGE \
	"mmc dev 1;" \
	"mmc read ${params_loadaddr} 7800 1" \

/* 
 * minli-port-181011
 * Add boot paraments command define
 *
 */
 ...
 *
#define CONFIG_MPU2MCU_UART
 */
#ifdef CONFIG_MPU2MCU_UART
#define CONFIG_MPU2MCUC_UART_BASE	UART3_BASE
#define	CONFIG_MPU2MCU_BAUDRATE		38400
#endif
