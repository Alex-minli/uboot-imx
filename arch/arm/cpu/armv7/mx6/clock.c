...
{
// minli-debug_logo
	debug_video("%s: ipu = %d, di = %d, freq = %8dHz\n", __func__, ipu, di, freq);
#ifdef LVDS_CLOCK_SRC_PLL5
	debug_video("\tLVDS_CLOCK_SRC_PLL5 defined\n");
#else
	debug_video("\tLVDS_CLOCK_SRC_PLL5 not defined\n");
#endif
...
{
// minli-debug_logo
	debug_video("%s: clk type = %d, freq = %8dHz\n", __func__, clk_type, freq);
