...
{
// minli-debug_logo
//	debug_video("%s:\n\t IPU = %d, ID_addr = 0x%08x, ID_mask = 0x%08x, data = 0x%08x\n", __func__, IPU, ID_addr, ID_mask, data);
...
// minli-debug_logo
	debug_video("\t %s: IPU = %d, ID_addr = 0x%08x, ID_mask = 0x%08x, data = 0x%08x\n", __func__, IPU, ID_addr, ID_mask, rdata);
}
...
// minli-debug_logo
	debug_video("\t Initialize CPMEM:\n");

	debug_video("\t write CPMEM_WORD0_DATA0_INT(0x%08x) = 0x%08x\n", IPU_BASE_ADDRE + CPMEM_WORD0_DATA0_INT__ADDR + (ipu_channel_params.channel<<6), w0_d0);
	debug_video("\t write CPMEM_WORD0_DATA1_INT(0x%08x) = 0x%08x\n", IPU_BASE_ADDRE + CPMEM_WORD0_DATA1_INT__ADDR + (ipu_channel_params.channel<<6), w0_d1);
	debug_video("\t write CPMEM_WORD0_DATA2_INT(0x%08x) = 0x%08x\n", IPU_BASE_ADDRE + CPMEM_WORD0_DATA2_INT__ADDR + (ipu_channel_params.channel<<6), w0_d2);
	debug_video("\t write CPMEM_WORD0_DATA3_INT(0x%08x) = 0x%08x\n", IPU_BASE_ADDRE + CPMEM_WORD0_DATA3_INT__ADDR + (ipu_channel_params.channel<<6), w0_d3);
	debug_video("\t write CPMEM_WORD0_DATA4_INT(0x%08x) = 0x%08x\n\n", IPU_BASE_ADDRE + CPMEM_WORD0_DATA4_INT__ADDR + (ipu_channel_params.channel<<6), w0_d4);

	debug_video("\t write CPMEM_WORD1_DATA0_INT(0x%08x) = 0x%08x\n", IPU_BASE_ADDRE + CPMEM_WORD1_DATA0_INT__ADDR + (ipu_channel_params.channel<<6), w1_d0);
	debug_video("\t write CPMEM_WORD1_DATA1_INT(0x%08x) = 0x%08x\n", IPU_BASE_ADDRE + CPMEM_WORD1_DATA1_INT__ADDR + (ipu_channel_params.channel<<6), w1_d1);
	debug_video("\t write CPMEM_WORD1_DATA2_INT(0x%08x) = 0x%08x\n", IPU_BASE_ADDRE + CPMEM_WORD1_DATA2_INT__ADDR + (ipu_channel_params.channel<<6), w1_d2);
	debug_video("\t write CPMEM_WORD1_DATA3_INT(0x%08x) = 0x%08x\n", IPU_BASE_ADDRE + CPMEM_WORD1_DATA3_INT__ADDR + (ipu_channel_params.channel<<6), w1_d3);
	debug_video("\t write CPMEM_WORD1_DATA4_INT(0x%08x) = 0x%08x\n\n", IPU_BASE_ADDRE + CPMEM_WORD1_DATA4_INT__ADDR + (ipu_channel_params.channel<<6), w1_d4);
}
...
// minli-debug_logo
	debug_video("%s:\n\t IPU = %d, IPU_BASE_ADDRE = 0x%08x\n", __func__, IPU, IPU_BASE_ADDRE);
#ifdef IPU_USE_DC_CHANNEL
	debug_video("\t IPU_USE_DC_CHANNEL defined \n");
#else
	debug_video("\t IPU_USE_DC_CHANNEL not defined \n\n");
#endif
...
// minli-debug_logo
	...
	debug_video("\t write IPU_DMFC_WR_CHAN_DEF(0x%08x) = 0x%08x\n", IPU_BASE_ADDRE + IPU_DMFC_WR_CHAN_DEF__ADDR, 0x202020F6);
	debug_video("\t write IPU_DMFC_WR_CHAN(0x%08x) = 0x%08x\n\n", IPU_BASE_ADDRE + IPU_DMFC_WR_CHAN__ADDR, 	0x00000090);

	debug_video("\t DMFC Display Processor Channel Initialize:\n");
	debug_video("\t write IPU_DMFC_DP_CHAN(0x%08x) = 0x%08x\n", IPU_BASE_ADDRE + IPU_DMFC_DP_CHAN__ADDR, 	0x0000968A);
	debug_video("\t write IPU_DMFC_DP_CHAN_DEF(0x%08x) = 0x%08x\n\n", IPU_BASE_ADDRE + IPU_DMFC_DP_CHAN_DEF__ADDR, 0x2020F6F6);

	debug_video("\t IDMAC Channel Priority 1 Initialize:\n");
	debug_video("\t write IPU_IDMAC_CH_PRI_1(0x%08x) = 0x%08x\n\n", IPU_BASE_ADDRE + IPU_IDMAC_CH_PRI_1__ADDR, 	0x18800001);

	debug_video("\t Display General Control Register Initialize:\n");
	debug_video("\t write IPU_IPU_DISP_GEN(0x%08x) = 0x%08x\n\n", IPU_BASE_ADDRE + IPU_IPU_DISP_GEN__ADDR, 	0x00400000 | (8 << 18));
...
//	 Brust size = 8, FIFO size = 256, Segment 2
	debug_video("\t CH28: Watermark clear = 111, set = 101, Enable\n\t       Brust size = 8, FIFO size = 128, Segment 0\n");
	debug_video("\t CH27: Watermark clear = 111, set = 101, Enable\n\t       Brust size = 8, FIFO size = 128, Segment 6\n");
	debug_video("\t CH23: Watermark clear = 111, set = 101, Enable\n\t       Brust size = 8, FIFO size = 256, Segment 2\n");
}
...
// minli-debug_logo
	debug_video("%s:\n", __func__);
	debug_video("\t DP Common Configuration Sync Flow Initialize:\n");
...
// minli-debug_logo
	debug_video("\n");
	debug_video("\t -> Gamma correction block disable\n");
	debug_video("\t -> CSC_YUV_SAT_MODE is zero(Y/U/V range 0 -255)\n");
	debug_video("\t -> disable GAMUT mapping\n");
	debug_video("\t -> disable CSC(Color Space Conversion)\n");
	debug_video("\t -> Transparent, cursor is disabled\n");
	debug_video("\t -> GWCKE - Graphic Window Color Keying disabled\n");
	debug_video("\t -> GWAM  - Graphic Window Alpha Mode = global Alpha\n");
	debug_video("\t -> GWSEL - Graphic Window Select partial plane\n");
}
...
{
// minli-debug_logo
	debug_video("%s: Config DC template's commands description\n", __func__);
	debug_video("\t ipu_num = %d,\t word address= %d\n", ipu_num, word);
	debug_video("\t opcode = %s\n", opcode);
	debug_video("\t stop = %d,\t lf = %d,\t af = %d,\t operand = %d\n", stop, lf, af, operand);
	debug_video("\t mapping = %d,\t waveform = %d,\t gluelogic = %d,\t sync = %d\n\n", mapping, waveform, gluelogic, sync);
...
// minli-debug_logo
	debug_video("\t LowWord:  reg(0x%08x) = 0x%08x\n", IPU_BASE_ADDRE + IPU_MEM_DC_MICROCODE_BASE_ADDR + word * 8, LowWord);
	debug_video("\t HighWord: reg(0x%08x) = 0x%08x\n", IPU_BASE_ADDRE + IPU_MEM_DC_MICROCODE_BASE_ADDR + word * 8 + 4, HighWord);
}
...
// minli-debug_logo
	debug_video("%s:\n", __func__);
	debug_video("\t ipu_num = %d, DC channel = %d, Event = \"%s\" , priority = %d, template's commands address = %d\n\n", ipu_num, channel, event, priority, address);
...
#endif
// minli-debug_logo
	debug_video("\t mapping pntr for OFFSET & MASK : %d\n", mapping);
	...
	**********************************************************************/
// minli-debug_logo
	debug_video("\t link events to routinesn\n");
	debug_video("\t Use DC Channel:%d <=> IDMAC is 28\n", DC_CHANNEL_DC_SYNC_OR_ASYNC);
	...
	**********************************************************************/
// minli-debug_logo
	debug_video("\n\n\t link events to routinesn\n");
	debug_video("\t Use DC Channel:%d <=> IDMAC Channel: 23/27\n", DC_CHANNEL_DP_PRIMARY);
	...
	//WR_CH_CONF_5  
// minli-debug_logo
	debug_video("\n\t DC Write Channel 5 Configuration Initialize:\n");
...
#endif
// minli-debug_logo
	debug_video("\n\t DC Write Channel 5 Address Configuration Initialize:\n");
	...
	//GENERAL 
// minli-debug_logo
	debug_video("\n\t DC General Register Initialize:\n");
	...
	//DISP_CONF  
// minli-debug_logo
	debug_video("\n\t DC Display Configuration Initialize:\n");
	...
	//DC_UGDE 
// minli-debug_logo
	debug_video("\n\t DC User General Data Event 1 Initialize:\n");
...
// minli-debug_logo
	debug_video("\n\t -> DC mapping point 1, IPU_PIX_FMT_RGB24. offset(BYTE0, 1, 2): 0, 1, 2\n");
	// config DC mapping point 1, IPU_PIX_FMT_RGB24
	ipu_write_field(IPU, IPU_DC_MAP_CONF_15__MD_OFFSET_0, 7);
	ipu_write_field(IPU, IPU_DC_MAP_CONF_15__MD_MASK_0, 0xFF);
	ipu_write_field(IPU, IPU_DC_MAP_CONF_15__MD_OFFSET_1, 15);
...
// minli-debug_logo
	debug_video("\n\t -> DC mapping point 2, IPU_PIX_FMT_RGB666. offset(BYTE0, 1, 2): 3, 4, 5\n");
	// config DC mapping point 2, IPU_PIX_FMT_RGB666
	ipu_write_field(IPU, IPU_DC_MAP_CONF_16__MD_OFFSET_3, 5);
	ipu_write_field(IPU, IPU_DC_MAP_CONF_16__MD_MASK_3, 0xFC);
	ipu_write_field(IPU, IPU_DC_MAP_CONF_17__MD_OFFSET_4, 11);
...
// minli-debug_logo
	debug_video("\n\t -> DC mapping point 3, IPU_PIX_FMT_YUV444. offset(BYTE0, 1, 2): 6, 7, 8\n");
	// config DC mapping point 3, IPU_PIX_FMT_YUV444
	ipu_write_field(IPU, IPU_DC_MAP_CONF_18__MD_OFFSET_6, 15);
	ipu_write_field(IPU, IPU_DC_MAP_CONF_18__MD_MASK_6, 0xFF);
	ipu_write_field(IPU, IPU_DC_MAP_CONF_18__MD_OFFSET_7, 23);
...
// minli-debug_logo
	debug_video("\n\t -> DC mapping point 4, IPU_PIX_FMT_RGB565. offset(BYTE0, 1, 2): 9, 10, 11\n");
	// config DC mapping point 4, IPU_PIX_FMT_RGB565
	ipu_write_field(IPU, IPU_DC_MAP_CONF_19__MD_OFFSET_9, 4);
	ipu_write_field(IPU, IPU_DC_MAP_CONF_19__MD_MASK_9, 0xF8);
	ipu_write_field(IPU, IPU_DC_MAP_CONF_20__MD_OFFSET_10, 10);
...
// minli-debug_logo
	debug_video("\n\t -> DC mapping point 5, IPU_PIX_FMT_LVDS666. offset(BYTE0, 1, 2): 12, 13, 14\n");
	// config DC mapping point 5, IPU_PIX_FMT_LVDS666
	ipu_write_field(IPU, IPU_DC_MAP_CONF_21__MD_OFFSET_12, 5);
	ipu_write_field(IPU, IPU_DC_MAP_CONF_21__MD_MASK_12, 0xFC);
	ipu_write_field(IPU, IPU_DC_MAP_CONF_21__MD_OFFSET_13, 13);
...
// minli-debug_logo
	debug_video("\n\t -> DC mapping point 6,7, IPU_PIX_FMT_VYUY. offset(BYTE0, 1, 2): 15, 16, 17 ### 18, 19, 20\n");
	// config DC mapping point 6,7, IPU_PIX_FMT_VYUY
	ipu_write_field(IPU, IPU_DC_MAP_CONF_22__MD_OFFSET_15, 7);
	ipu_write_field(IPU, IPU_DC_MAP_CONF_22__MD_MASK_15, 0xFF);
	ipu_write_field(IPU, IPU_DC_MAP_CONF_23__MD_OFFSET_16, 0);
...
// minli-debug_logo
	debug_video("\n\t -> DC mapping point 8,9, IPU_PIX_FMT_UYVY. offset(BYTE0, 1, 2): 18, 19, 20 ### 15, 16, 17\n");
	// config DC mapping point 8,9, IPU_PIX_FMT_UYVY
	ipu_write_field(IPU, IPU_DC_MAP_CONF_3__MAPPING_PNTR_BYTE0_7, 18);
	ipu_write_field(IPU, IPU_DC_MAP_CONF_3__MAPPING_PNTR_BYTE1_7, 19);
	ipu_write_field(IPU, IPU_DC_MAP_CONF_3__MAPPING_PNTR_BYTE2_7, 20);
...
// minli-debug_logo
	debug_video("\n\t -> DC mapping point 10,11, IPU_PIX_FMT_YUYV. offset(BYTE0, 1, 2): 17, 16, 15 ### 16, 17, 15\n");
	// config DC mapping point 10,11, IPU_PIX_FMT_YUYV
	ipu_write_field(IPU, IPU_DC_MAP_CONF_4__MAPPING_PNTR_BYTE0_9, 17);
	ipu_write_field(IPU, IPU_DC_MAP_CONF_4__MAPPING_PNTR_BYTE1_9, 16);
	ipu_write_field(IPU, IPU_DC_MAP_CONF_4__MAPPING_PNTR_BYTE2_9, 15);
...
// minli-debug_logo
	debug_video("\n\t -> DC mapping point 12,13, IPU_PIX_FMT_YVYU. offset(BYTE0, 1, 2): 16, 17, 15 ### 17, 16, 15\n");
	// config DC mapping point 12,13, IPU_PIX_FMT_YVYU
	ipu_write_field(IPU, IPU_DC_MAP_CONF_5__MAPPING_PNTR_BYTE0_11, 16);
	ipu_write_field(IPU, IPU_DC_MAP_CONF_5__MAPPING_PNTR_BYTE1_11, 17);
	ipu_write_field(IPU, IPU_DC_MAP_CONF_5__MAPPING_PNTR_BYTE2_11, 15);
...
// minli-debug_logo
	debug_video("\n\t -> DC mapping point 14, IPU_PIX_FMT_GBR24. offset(BYTE0, 1, 2): 2, 0, 1\n");
	// config DC mapping point 14, IPU_PIX_FMT_GBR24, IPU_PIX_FMT_VYU444
	ipu_write_field(IPU, IPU_DC_MAP_CONF_6__MAPPING_PNTR_BYTE0_13, 2);
	ipu_write_field(IPU, IPU_DC_MAP_CONF_6__MAPPING_PNTR_BYTE1_13, 0);
	ipu_write_field(IPU, IPU_DC_MAP_CONF_6__MAPPING_PNTR_BYTE2_13, 1);
...
// minli-debug_logo
	debug_video("\n\t -> DC mapping point 15, IPU_PIX_FMT_BGR24. offset(BYTE0, 1, 2): 2, 1, 0\n");
	// config DC mapping point 15, IPU_PIX_FMT_BGR24
	ipu_write_field(IPU, IPU_DC_MAP_CONF_7__MAPPING_PNTR_BYTE0_14, 2);
	ipu_write_field(IPU, IPU_DC_MAP_CONF_7__MAPPING_PNTR_BYTE1_14, 1);
	ipu_write_field(IPU, IPU_DC_MAP_CONF_7__MAPPING_PNTR_BYTE2_14, 0);
...
// minli-debug_logo
	debug_video("%s:\n", __func__);
	debug_video("\t ipu_num = %d, di = %d\n", ipu_num, di);
	debug_video("\t pointer = %d\n", pointer);
	debug_video("\t offset_value = %d,\t offset_resolution = %d\n", offset_value, offset_resolution);
	debug_video("\t run_value_m1 = %d,\t run_resolution = %d\n\n", run_value_m1, run_resolution);

	debug_video("\t cnt_clr_sel = %d\n", cnt_clr_sel);
	debug_video("\t cnt_up = %d,\t cnt_down = %d\n", cnt_up, cnt_down);
	debug_video("\t cnt_polarity_gen_en = %d,\t cnt_polarity_trigger_sel = %d, cnt_polarity_clr_sel = %d\n", cnt_polarity_gen_en, cnt_polarity_trigger_sel, cnt_polarity_clr_sel);
	debug_video("\t gentime_sel = %d\n\n", gentime_sel);

	debug_video("\t cnt_auto_reload = %d, step_repeat = %d\n\n", cnt_auto_reload, step_repeat);

	debug_video("\t Set DI Sync Wave Gen %d Register 0 & 1: DI0_SW_GEN0_%d & DI0_SW_GEN1_%d\n", pointer, pointer, pointer);
...
// minli-debug_logo
	debug_video("%s:\n", __func__);
	debug_video("\t ipu_num = %d, di = %d\n", ipu_num, di);
	debug_video("\t pointer = %d, access = %d, component = %d\n", pointer, access, component);
	debug_video("\t cst = %d, pt0 = %d, pt1 = %d, pt2 = %d, pt3 = %d, pt4 = %d, pt5 = %d, pt6 = %d\n", cst, pt0, pt1, pt2, pt3, pt4, pt5, pt6);
...
// minli-debug_logo
	debug_video("%s:\n", __func__);
	debug_video("\t ipu_num = %d, di = %d\n", ipu_num, di);
	debug_video("\t pointer = %d, set = %d, up = %d, down = %d\n", pointer, set, up, down);
...
// minli-debug_logo
	debug_video("\t Initialize ipu_channel_params:\n");
	debug_video("\t ipu_channel_params.channel = %d\n\n", ipu_channel_params.channel);

	debug_video("\t ipu_channel_params.eba0 = 0x%08x (0x%08x / 8)\n", ipu_channel_params.eba0, DISPLAY_EBA0);
	debug_video("\t ipu_channel_params.eba1 = 0x%08x\n", ipu_channel_params.eba1);
	debug_video("\t ipu_channel_params.fw = %d\n", ipu_channel_params.fw);
	debug_video("\t ipu_channel_params.fh = %d\n", ipu_channel_params.fh);
	debug_video("\t ipu_channel_params.sl = %d\n", ipu_channel_params.sl);
	debug_video("\t ipu_channel_params.npb = %d\n", ipu_channel_params.npb);
	debug_video("\t ipu_channel_params.pfs = %d\n\n", ipu_channel_params.pfs);

	debug_video("\t ipu_channel_params.bpp = %d\n", ipu_channel_params.bpp);
	debug_video("\t ipu_channel_params.wid0 = %d\n", ipu_channel_params.wid0);
	debug_video("\t ipu_channel_params.wid1 = %d\n", ipu_channel_params.wid1);
	debug_video("\t ipu_channel_params.wid2 = %d\n", ipu_channel_params.wid2);
	debug_video("\t ipu_channel_params.wid3 = %d\n", ipu_channel_params.wid3);
	debug_video("\t ipu_channel_params.ofs0 = %d\n", ipu_channel_params.ofs0);
	debug_video("\t ipu_channel_params.ofs1 = %d\n", ipu_channel_params.ofs1);
	debug_video("\t ipu_channel_params.ofs2 = %d\n", ipu_channel_params.ofs2);
	debug_video("\t ipu_channel_params.ofs3 = %d\n\n", ipu_channel_params.ofs3);

	debug_video("\t ipu_channel_params.so = %d\n", ipu_channel_params.so);
	debug_video("\t ipu_channel_params.ilo = %d\n", ipu_channel_params.ilo);
	debug_video("\t ipu_channel_params.sl = %d\n\n", ipu_channel_params.sl);
...
// minli-debug_logo
	debug_video("\t ipuDiClk = %d, typPixClk = %d, div (ipuDiClk / typPixClk + 0.5) = %d\n", ipuDiClk, typPixClk, div);
	debug_video("\t hSyncStartWidth = %d, hSyncWidth = %d, hDisp = %d, hSyncEndWidth = %d\n", hSyncStartWidth, hSyncWidth, hDisp, hSyncEndWidth);
	debug_video("\t vSyncStartWidth = %d, vSyncWidth = %d, vDisp = %d, vSyncEndWidth = %d\n", vSyncStartWidth, vSyncWidth, vDisp, vSyncEndWidth);

	// config (DRDY signal) DI_PIN15
	//di_pointer_config(IPU, di, pointer, access, componnent, cst, pt0, pt1, pt2, pt3, pt4, pt5, pt6);
// minli-debug_logo
	debug_video("\n\t config (DRDY signal) DI_PIN15\n");
	debug_video("\t use DW_SET%d_<%d> for PIN 15.\n", DI_DEN_SIGNAL, DI_SDC_WAVEFORM);
	debug_video("\t use DW_SET%d_<%d> for Other Pin.\n", DI_NOUSE_SIGNAL, DI_SDC_WAVEFORM);
...
// minli-debug_logo
	debug_video("\t CLK Offset = 0, CLK PERIOD = 1. time base clock = DI clock\n");
	debug_video("\t CLK Up =%d, CLK Down = %d. DISP clock = time base clock\n", clkUp, clkDown);
	debug_video("\t DI_SCR_CONF, set the screen height = %d\n", vDisp + vSyncStartWidth + vSyncEndWidth + vSyncWidth - 1);
	...
	{
// minli-debug_logo
		debug_video("\t VSYNC is coming from counter #3 .\n");
...
// minli-debug_logo
// Need mask IPU2 process,otherwise will lockup
...
#ifdef IPU_USE_DC_CHANNEL
// minli-debug_logo
	debug_video("IPU_USE_DC_CHANNEL defined, enable channel 28.\n");
...
#else
// minli-debug_logo
	debug_video("IPU_USE_DC_CHANNEL not defined, enable channel 23.\n");
